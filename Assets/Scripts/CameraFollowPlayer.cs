...
public class CameraFollowPlayer : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            transform.position = new Vector3(59.8f, playerTransform.position.y, cameraOffset);
